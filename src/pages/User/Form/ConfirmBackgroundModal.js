...
const ConfirmBackgroundModal = ({ show, onConfirm, onCancel, selectedThemeId }) => {
    ...
    const handleConfirm = async () => {
        ...
        const previousUserTemplateDetailId = sessionStorage.getItem("navBackgroundId");
...
export default ConfirmBackgroundModal;
